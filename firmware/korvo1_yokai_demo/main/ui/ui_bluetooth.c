...
lv_obj_t *ui_bluetooth_screen_create(ui_bt_home_cb_t home_cb)
{
    ...
    lv_obj_set_size(btn_home, 110, 34);
    ...
    lv_obj_set_pos(lbl_title, 140, 14);
    ...
    lv_obj_set_pos(lbl_sw, 16, 52);

    s_sw_radio = lv_switch_create(card_dev);
    lv_obj_set_pos(s_sw_radio, 260, 48);
    ...
    lv_obj_set_pos(lbl_name_tag, 16, 100);
    ...
    lv_obj_set_pos(lbl_dev_name, 16, 122);
    ...
    lv_obj_set_pos(lbl_disc, 16, 164);

    /* Instructions Box */
    lv_obj_t *box_inst = lv_obj_create(card_dev);
    lv_obj_set_size(box_inst, 328, 170);
    lv_obj_set_pos(box_inst, 16, 196);
    ...
    lv_obj_set_pos(lbl_inst_c, 8, 30);

    /* --- Right Top: Current Connection Card (380x190px) --- */
    lv_obj_t *card_conn = lv_obj_create(s_scr_bt);
    lv_obj_add_style(card_conn, &ui_style_glass_card, 0);
    lv_obj_set_size(card_conn, 380, 190);
    ...
    lv_obj_set_pos(lbl_c_tag, 16, 14);

    s_lbl_conn_title = lv_label_create(card_conn);
    lv_label_set_text(s_lbl_conn_title, "未接続 (スマートフォンから接続)");
    ...
    lv_obj_set_pos(s_lbl_conn_title, 16, 50);
    ...
    lv_obj_set_pos(s_lbl_conn_desc, 16, 84);
    ...
    lv_obj_set_pos(s_lbl_stream_badge, 16, 114);
    ...
    lv_obj_set_pos(s_btn_disconnect, 240, 136);
    ...
    lv_obj_set_pos(lbl_v_tag, 16, 14);
    ...
    lv_obj_set_pos(s_lbl_bt_vol_val, 290, 80);
    ...
    lv_obj_set_pos(lbl_v_hint, 16, 126);
